...
export const deeptrainAppName = import.meta.env.VITE_DEEPTRAIN_APP || "newchat";
...
export function setDocsUrl(url: string): void {
   ...
   */
  url = url.trim() || "https://docs.newchat.net";
...
export function setBlobEndpoint(endpoint: string): void {
   ...
   */
  endpoint = endpoint.trim() || "https://blob.newchat.net";
